...
extern int scanhash_bcd(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_bcd(int thr_id);
...
void bcd_hash(void *output, const void *input);
