...
void quark_jh512_gpu_hash_128_keccak_128(uint32_t threads, uint32_t* g_hash, const uint32_t* __restrict__ g_nonceVector){
...
__host__
void quark_jh512_cpu_hash_128_keccak_128(int thr_id, uint32_t threads, uint32_t *d_nonceVector, uint32_t *d_hash)
{
	dim3 grid((threads + TPB-1)/TPB);
	dim3 block(TPB);

	quark_jh512_gpu_hash_128_keccak_128<<<grid, block>>>(threads, d_hash, d_nonceVector);
}