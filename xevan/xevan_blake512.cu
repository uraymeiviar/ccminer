...
void xevan_blake512_gpu_hash_128(uint32_t threads,  uint64_t *g_hash)
{
...
__host__
void xevan_blake512_cpu_hash_128(int thr_id, uint32_t threads, uint32_t *d_outputHash)
{
		const uint32_t threadsperblock = TPB_128_B;
		dim3 grid((threads + threadsperblock-1)/threadsperblock);
		dim3 block(threadsperblock);
		xevan_blake512_gpu_hash_128<<<grid, block>>>(threads,  (uint64_t*)d_outputHash);
}
...
void xevan_blake512_gpu_hash_80_bmw_128(const uint32_t threads,const uint32_t startNounce, uint2x4 *const __restrict__ g_hash){
...
__host__
void xevan_blake512_cpu_hash_80_bmw_128(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *d_outputHash){
	dim3 grid((threads + TPB80-1)/TPB80);
	dim3 block(TPB80);

	xevan_blake512_gpu_hash_80_bmw_128<<<grid, block>>>(threads, startNounce, (uint2x4*)d_outputHash);
}