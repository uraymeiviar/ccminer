...
void xevan_luffa512_gpu_hash_128(uint32_t threads, uint32_t *g_hash)
{
...
__host__
void xevan_luffa512_cpu_hash_128(int thr_id, uint32_t threads,uint32_t *d_hash)
{
    ...
    xevan_luffa512_gpu_hash_128<<<grid, block>>>(threads,d_hash);
}
